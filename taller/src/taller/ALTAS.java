...
public class ALTAS extends javax.swing.JFrame {
    ...
    String ap_pat=jTextField2.getText();
    String ap_mat=jTextField3.getText();
    String fech_nac=jTextField4.getText();
    String edo_civil=jTextField5.getText();
    String gdo_est=jTextField6.getText();
    String genero=jTextField7.getText();
    

        Taller t=new Taller();
      t.conectar(nombre,ap_pat,ap_mat,fech_nac,edo_civil,gdo_est,genero);
 jTextField1.setText("");
    jTextField2.setText("");
    jTextField3.setText("");
    jTextField4.setText("");
