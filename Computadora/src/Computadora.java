...
*/
import javax.swing.JOptionPane; //se importa de la paqueteria JOptionpane
public class Computadora{ //se hace publica la clase
	
	int discoDuro;
	double velocidadProcesador; //se cambia el tipo de dato;
	Computadora peer;
	String sistemaOperativo;
	String nombre;
        String [] memoria; //se esta manejando un array;

	public Computadora(String nombreEquipo){ //Renombracion de computadora a Computadora;
		discoDuro = 640;
	...
	public boolean ejecutar(String programa, int posicion){
		if(posicion != 0){
            ...
            return false; //si no pasa al if entonces retornara false;
		}
	// } Esta llave esta demas
	...
	public void aumentarDiscoDuro(){ //se borra el metodo static
		discoDuro = 1000;
	}
